...
- **Retargeting audience:** a list, built automatically by the ad platforms, of people who watched or engaged with your videos. You can show ads only to those people. [A video view from the right prospect is a hand-raise](/blog/attention-to-revenue-system).
- **Qualified sales call:** a conversation with someone who fits, has the problem, can pay and is ready to talk about it. [The only marketing metric that matters](/blog/qualified-sales-calls).
...
Retargeting audiences being built from viewers, a landing path with an offer on it, follow-up that runs whether or not the founder remembers. Without this, video produces the Attention Leak: people saying "I see you everywhere" and a pipeline that hasn't noticed. [Demand generation without lead generation](/blog/demand-generation-vs-lead-generation) is how most "we tried video" stories end.
...
- **Synthetic delivery would jar in your category.** There are moments where a generated presenter is the wrong messenger. Parts of funeral care are one; grief doesn't want an avatar. That isn't a reason to avoid paid acquisition in those sectors. [Compare Funerals' 30-day result](/blog/compare-funerals-30-day-case-study) came from ads built around what the buyer actually cares about, not from a generated presenter. It's a reason to choose the format by the buyer, not by the tool.
...
1. Do referrals close at a noticeably higher rate than paid leads?
2. Does your sales team spend the first part of every call explaining the basics?
3. Do you have reviews, case studies or completed work that prospects never see before they enquire?
...
No. It makes them work harder. Content warms the audience and builds retargeting lists; ads capture the demand that creates. Run separately, content produces attention that leaks and ads sell cold to strangers. Run together they're one loop, which is the [Attention-to-Revenue System](/blog/attention-to-revenue-system) end to end.

## Sources

- Wyzowl, [Video Marketing Statistics 2026](https://wyzowl.com/video-marketing-statistics/): survey of 266 marketers and consumers conducted in late 2025. 91% of businesses use video; 63% of video marketers have used AI video tools (51% the prior year); 82% report a good ROI; 67% measure ROI by views, 63% by engagement and 32% by bottom-line sales; 89% of consumers say video quality affects their trust in a brand.
- Fash, [Videographer Prices & Rates (2026 data)](https://fash.com/costs/videography-prices): corporate commercials and marketing videos $1,000–$5,000+; video production $800–$4,000 per finished minute.
