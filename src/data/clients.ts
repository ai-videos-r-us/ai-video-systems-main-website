...
export interface ReviewShot {
  ...
  width: number;
  height: number;
  /** Results screenshot rendered in the same card, directly beneath the review. */
  proof?: {
    src: string;
    alt: string;
    width: number;
...
export const REVIEW_SHOTS: ReviewShot[] = [
  {
    ...
    height: 286,
    proof: {
      src: '/reviews/proof-jack-smith.webp',
      alt: 'WhatsApp messages from Jack Smith at Compare Funerals reporting monthly results — 338 leads, 155 accepted, 26 sales at just under 17%, “we are now on 21% overall” — and a lead that closed twice: “no marketing but came in 14th Aug… sold x 2.”',
      width: 1080,
      height: 1080,
    },
  },
  {
    ...
    height: 243,
    proof: {
      src: '/reviews/proof-sam-curtis.webp',
      alt: 'Instagram comments and WhatsApp enquiries generated by Ironclad Finance content — first-time buyers asking how to apply and messaging in to be qualified for mortgages.',
      width: 940,
      height: 788,
    },
  },
